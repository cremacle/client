...
const Edit = () => {
  ...
  const [person_position, set_person_position] = useState("");
  const [person_level, set_person_level] = useState("");
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        set_person_position(response.data.person_position)
        set_person_level(response.data.person_level)
      })
  ...
  const onChangePersonName = (prop) => {
    set_person_name(prop.target.value)
  }
  const onChangePersonPosition = (prop) => {
    set_person_position(prop.target.value)
  }
  const onChangePersonLevel = (prop) => {
    set_person_level(prop.target.value)
  }
  const onSubmit = (prop) => {
